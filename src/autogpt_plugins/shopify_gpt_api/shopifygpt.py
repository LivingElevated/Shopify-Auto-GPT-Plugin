...
def analyze_sales() -> Dict[str, Any]:
    ...
    return {"total_sales": total_sales, "product_sales": product_sales, "product_percentage_contribution": product_percentage_contribution, "slow_moving_products": slow_moving_products}
